...
> _Please note that the following code will download several relatively large files. Alternatively, you can download selected files by using their individual SRA code. For example, download "SK1 WT / S288c WT Input rep 1" by running:_ `$ fasterq-dump SRX4108751`
